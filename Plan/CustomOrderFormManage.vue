<template>
    <div id="ProductPlanManagement" ref="CustomOrderFormManage">
        ...
        <CustomOrderFormEditPanel :currentObj_prop="currentObj_prop"
                                  :mode="mode"
                                  :company_idList="autocompleteDataList2"
    ...
    export default {
        data(){
            return {
                ...
                isCompanyIdEditable: true,//company_id是否可编辑标志
              ...
              try{
                  request({
                      ...
                      params: {
                        ...
                        company_id: !this.searchForm.company_id ? null : this.searchForm.company_id.trim(),
              ...
              try{
                  ...
                  params: {
                      ...
                      for(var i=0;i<this.count;i++){
                          ...
                          array2.push(this.tableData[i].company_id)
                      }
                      ...
                      for(var i=0;i<this.count;i++){
                          ...
                          autoCompleteData2.value =this.tableData[i].company_id;
