...
public interface LineMapper {
    ...
    List<QueryProductVo> searchProductId();

    List<newLineVo> getLinesByWorkshop(@Param("workshopId") String workshopId);

    List<newLineVo> selectPageLines(@Param("workshopId") String workshopId,@Param("start") long start, @Param("num") long num);

    Integer getCountByWorkshopId(@Param("workshopId") String workshopId);
}
