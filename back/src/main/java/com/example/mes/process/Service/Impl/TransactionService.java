...
//            }
            ...
            for(InsertRoutingProcedureVo item:data){
                ...
                insertRoutingProcedureVos.add(new com.example.mes.process.Vo.RoutingVo.InsertRoutingProcedureVo(uuid,procedure_id,order++));
            }
    ...
    public String update(UpdateVo updateVo) {
        try {
            ...
            for(UpdateRoutingProcedureVo item:data){
                ...
                insertRoutingProcedureVos.add(new com.example.mes.process.Vo.RoutingVo.InsertRoutingProcedureVo(product_id,procedure_id,order++));
            }
