  ...
  methods:{
    ...
    getData(){
      ...
      my_request({
        ...
        console.log('物料的getdata：res',res)
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          let req = {
            ...
            // user : 1,
            type : 'material',
            id : this.$route.query.info.material_id,
    ...
    handleSearch(index,row){
      ...
      this.updateInfo.id = this.$route.query.info.material_id
      this.updateInfo.type = 'material'
